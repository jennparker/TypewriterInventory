...
//TODO Animate the text for the splash screen
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Add Typewriter font for this screen
        Typeface typeface = Typeface.createFromAsset(getAssets(), "fonts/type_keys.ttf");
        ...
        splashButton.setOnTouchListener(mDelayHideTouchListener);
